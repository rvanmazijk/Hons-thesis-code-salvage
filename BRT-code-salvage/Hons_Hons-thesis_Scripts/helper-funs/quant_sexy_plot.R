...
quant_sexy_plot <- function(data, var_name,
    ...
    sexy_plot <- median_plot +
        labs(
            title = switch(var_name,
                "AWCh1"  = "AWCh1",
                "BLDFIE" = "BLDFIE (kg m-3)",
                "CECSOL" = "CECSOL (cmol c kg-1)",
                "CLYPPT" = "CLYPPT (mass %)",
                "CRFVOL" = "CRFVOL (volumetric %)",
                "elev"   = "elev (m)",
                "MAP"    = "MAP (mm year-1)",
                "MLST"   = "MLST (K)",
                "NDVI"   = "NDVI",
                "OCDENS" = "OCDENS (kg m-3)",
                "PCV"    = "PCV",
                "PDQ"    = "PDQ (mm month-1)",
                "PHIKCL" = "PHIKCL (pH)",
                "PWQ"    = "PWQ (mm month-1)",
    ...
    # TODO: use gridarrange to make one big set of panels :)

# Randomised raster null vs observed raster comparison function
...
# √ implement writing t test & f test to disc
...
compare_null_obs <- function(obs_dir, null_dir, compare_dir,

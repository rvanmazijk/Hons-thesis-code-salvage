# My saved objects for my Hons thesis analyses
...
MA_LST_GCFR_0.05_buffered <- raster(paste0(reswd, "MODIS_annual_mean_GCFR_0.05_buffered.grd"))
...
MA_LST_SWAFR_0.05_buffered <- raster(paste0(reswd, "MODIS_annual_mean_SWAFR_0.05_buffered.grd"))


# Buffered region polygons --------------------------------------------------------------

# 2017-06-30 17:31 TODO --- make buffered border polygons as if at factor 20 or 15?
#                           currently at 20, but that means the agg() plots' pixels *seem*
#                           misalgined (bc in a sense they are) witht he border poly

...
prelim_rand_compare <- function(x = NULL,
                                need_do_prelim_anal = FALSE, need_do_rand_null = FALSE,
                                border = NULL, border_buffer = NULL, facts = 2:15,
                                var_name = NULL, region_name = c("GCFR", "SWAFR"),
                                how_many_SARs = 1, how_many_rand_pts = 1000,
                                x_tester = NULL,
                                obs_dir, null_dir, compare_dir,
                                plot_format = c("PDF", "TIFF"), save_grd = TRUE) {
